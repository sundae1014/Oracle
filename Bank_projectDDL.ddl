...
insert into Customer values('660912-1234567', '원빈', '대전', '1966-09-12', 'on@daum.net', '010-2104-6609', '배우');
...
select 
    ...
    a.card_type
from card a
join customer b on b.cust_jumin = a.cust_jumin
